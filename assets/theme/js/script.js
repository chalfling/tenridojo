            ...
            $(event.target).outerFind('[data-bg-video]').each(function(){
                ...
                for (var i = 0; i < patterns.length; i++){
                    if (result = patterns[i].exec(videoURL)){
                        ...
                        previewURL += '//http://img.youtube.com/vi/' + result[1] + '/maxresdefault.jpg';
...
/*
     FILE ARCHIVED ON 08:27:50 Aug 22, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:19:47 Mar 26, 2022.
...
playback timings (ms):
  ...
  esindex: 0.008
  LoadShardBlock: 80.732 (3)
  PetaboxLoader3.datanode: 117.739 (4)
  CDXLines.iter: 16.534 (3)
  load_resource: 89.525
  PetaboxLoader3.resolve: 43.968
*/